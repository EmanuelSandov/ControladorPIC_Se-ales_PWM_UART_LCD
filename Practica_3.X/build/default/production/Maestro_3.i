                    ...
                    switch (key) {
                        ...
                        default:
                            if (charCount < 18 - 1) {
                                ...
                                if (cursorPosition < 18 - 1) cursorPosition++;
                                if (charCount < 18) charCount++;
                            }
                            break;
                    }
